...
success:function(a){a.error?"undefined"!==typeof a.responseText.redirect?(showMessage(a.responseText.msg,1),window.location.reload()):showMessage(a.responseText.msg,1):d?showConfirm("Go to the cart?",function(){window.location.href=c},function(){window.location.reload()}):window.location.href=c}})})});
