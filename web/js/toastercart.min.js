...
success:function(a){a.error?showMessage(a.responseText.msg,1):d?smoke.confirm("<span>Succces! Item(s) added to cart</span> You have added your selected item(s) to your cart. What do you want to do next?",function(a){a?window.location.href=c:window.location.reload()},{classname:"cart-info",ok:"View Cart / Checkout",cancel:"Continue Shopping"}):window.location.href=c}})})});
