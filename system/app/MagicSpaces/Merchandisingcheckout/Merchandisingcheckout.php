<?php
/**
 * MAGICSPACE: merchandisingcheckout
 * {merchandisingcheckout}{/merchandisingcheckout}
 */
class MagicSpaces_Merchandisingcheckout_Merchandisingcheckout extends Tools_MagicSpaces_Abstract
{
    ...
    protected function _run()
    {
        ...
        $merchandisingZoneTemplate = $this->_parse();
        $this->_sessionHelper->merchandisingZoneTmpl = $merchandisingZoneTemplate;
        $this->_content = $tmp;
